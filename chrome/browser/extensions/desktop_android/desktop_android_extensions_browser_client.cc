...
// Afterbird: small API provider that registers just the developerPrivate
// handlers chrome://extensions needs. Keeping it inline avoids a whole new
// file just for a single registry->RegisterFunction<...> list.
class AfterbirdChromeExtensionsBrowserAPIProvider
    : public ExtensionsBrowserAPIProvider {
 public:
  AfterbirdChromeExtensionsBrowserAPIProvider() = default;
  AfterbirdChromeExtensionsBrowserAPIProvider(
      const AfterbirdChromeExtensionsBrowserAPIProvider&) = delete;
  AfterbirdChromeExtensionsBrowserAPIProvider& operator=(
      const AfterbirdChromeExtensionsBrowserAPIProvider&) = delete;
  ~AfterbirdChromeExtensionsBrowserAPIProvider() override = default;
