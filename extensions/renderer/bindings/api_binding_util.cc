...
std::string GetPlatformString() {
  ...
  // Afterbird: our build targets regular Android (not Chromium's experimental
  // desktop_android), but reuses the desktop-android extension infrastructure.
  // Report as "desktop_android" so API feature gating works.
  return "desktop_android";
#else
  NOTREACHED();
#endif
