...
def generate_gperf(gperf_path, gperf_input, gperf_args):
    ...
    try:
        ...
        # Newer gperf already emits explicit fallthrough attributes guarded by
        # preprocessor checks. Replacing /*FALLTHROUGH*/ with [[fallthrough]]
        # in that case creates duplicated annotations and breaks clang parsing.
        # Keep legacy behavior only when gperf output does not provide any
        # built-in fallthrough attribute support.
        # https://savannah.gnu.org/bugs/index.php?53029
        if '__fallthrough__' in gperf_output or '[[fallthrough]]' in gperf_output:
